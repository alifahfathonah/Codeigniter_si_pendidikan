                                        ...
                                        <tr>
                                            ...
                                            */?>
                                            <td>
                                                ...
                                                <a href="<?= base_url();?>pegawai/hapus_pegawai/<?= $pgw['id_pegawai'];?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')" class="btn btn-default" style="padding: 2px"><i class="fa fa-trash-o"></i></a>
                                            </td>
                                        </tr>
                                        <?php $i++;?>
                                        <?php endforeach; ?>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="card">
                                    <div class="body">
                                        <form id="form_advanced_validation" method="post" action="<?= base_url();?>pegawai/edit_pegawai/<?= $pgw['id_pegawai'];?>">
