            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Data Pendidikan Menengah Atas dan Kejuruan
                                <!-- <small>Add <code>.table-bordered</code> for borders on all sides of the table and cells.</small> -->
                            </h2>
                            <hr>
                            <a href="" class="btn btn-primary" data-toggle="modal" data-target="#defaultModal" style="padding: 10px;"><i class="fa fa-plus-square"></i> Tambah Data Pendidikan Menengah Atas dan Kejuruan</a>
                            <a href="<?= base_url();?>sma" class="btn btn-success" style="padding: 10px; margin-right: 25px;"><i class="fa fa-refresh"></i></a>
                            <hr>
                        ...
                        <div class="body table-responsive">
                            <h4> Data Pendidikan Menengah Atas dan Kejuruan di Tahun <?= $sort;?> </h4>   
                        <hr>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td colspan="11"><b>VI. Pendidikan Menengah Atas dan Kejuruan*</b>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td width="1%">&nbsp;</td>
                                    <td colspan="6">2. Jumlah Bangunan Sekolah SMA/SMK/MA/Sederajat ** </td>
                                ...
                                <tr>
                                    ...
                                    <td width="1%">&nbsp;</td>
                                    <td colspan="6">3. Jumlah Pengelola Sekolah SMA/SMK/MA/Sederajat**   </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php foreach($pgl_negeri as $p):?>
                                            <a href="<?= base_url();?>sma/hapus_pgl_negeri/<?= $p['id_tb_pengelola_negeri'];?>" class="btn btn-default"><i class="fa fa-trash"></i></a>
                                        <?php endforeach;?>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td><a href="" class="btn btn-default" data-toggle="modal" data-target="#pglswasta"><i class="fa fa-edit"></i></a>
                                        <?php foreach($pgl_swasta as $p):?>
                                            <a href="<?= base_url();?>sma/hapus_pgl_swasta/<?= $p['id_tb_pengelola_swasta'];?>" class="btn btn-default"><i class="fa fa-trash"></i></a>
                                        <?php endforeach;?>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td width="1%">&nbsp;</td>
                                    <td colspan="6">4. Jumlah Ruang Kelas Sekolah SMA/SMK/MA/Sederajat  </td>
                                    ...
                                    <td><a href="" class="btn btn-default" data-toggle="modal" data-target="#rgkelas"><i class="fa fa-edit"></i></a>
                                        <?php foreach($rg_kelas as $p):?>
                                            <a href="<?= base_url();?>sma/hapus_rg_kelas/<?= $p['id_tb_ruang_kelas'];?>" class="btn btn-default"><i class="fa fa-trash"></i></a>
                                        <?php endforeach;?>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td width="1%">&nbsp;</td>
                                    <td colspan="6">5. Jumlah Tenaga Pendidik Sekolah SMA/SMK/MA/Sederajat**   </td>
                                ...
                                <tr>
                                    ...
                                    <td><a href="" class="btn btn-default" data-toggle="modal" data-target="#pdbersertifikat"><i class="fa fa-edit"></i></a>
                                        <?php foreach($pd_bersertifikat as $p):?>
                                            <a href="<?= base_url();?>sma/hapus_pd_bersertifikat/<?= $p['id_tb_pendidik_bersertifikat'];?>" class="btn btn-default"><i class="fa fa-trash"></i></a>
                                        <?php endforeach;?>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td><a href="" class="btn btn-default" data-toggle="modal" data-target="#pdtdkbersertifikat"><i class="fa fa-edit"></i></a>
                                        <?php foreach($pd_tdk_bersertifikat as $p):?>
                                            <a href="<?= base_url();?>sma/hapus_pd_tdk_bersertifikat/<?= $p['id_tb_pendidik_tdk_bersertifikat'];?>" class="btn btn-default"><i class="fa fa-trash"></i></a>
                                        <?php endforeach;?>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td><a href="" class="btn btn-default" data-toggle="modal" data-target="#rasio"><i class="fa fa-edit"></i></a>
                                        <?php foreach($rasio as $p):?>
                                            <a href="<?= base_url();?>sma/hapus_rasio/<?= $p['id_tb_rasio'];?>" class="btn btn-default"><i class="fa fa-trash"></i></a>
                                        <?php endforeach;?>
                                    </td>
                                </tr> 
                            </tbody>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="defaultModal">Tambah Data Pendidikan Menengah Pertama</h4>
            </div>
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <form id="form_advanced_validation" method="post" action="sma/tambahDataSma">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <p>Kecamatan</p>
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                <form id="form_advanced_validation" method="post" action="sma/tambahDataSmaUmum">
                                    <div class="form-group">
                                        <div class="form-line">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <b style="float: right;">
                                                    ...
                                                    <a href="<?= base_url();?>sma/hapus_siswa/<?= $p['id_tb_jml_siswa'];?>" class="btn btn-default"><i class="fa fa-trash"></i></a>
                                                </b>
                                            </td>
                                        </tr>
                                        <?php $i++;?>
            ...
            <div class="modal-body">
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="body">
                                <form id="form_advanced_validation" method="post" action="<?= base_url();?>sma/edit_peserta_siswa">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <b style="float: right;">
                                                    ...
                                                    <a href="<?= base_url();?>sma/hapus_bg_baik/<?= $p['id_tb_bangunan_baik'];?>" class="btn btn-default"><i class="fa fa-trash"></i></a>
                                                </b>
                                            </td>
                                        </tr>
                                        <?php $i++;?>
            ...
            <div class="modal-body">
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="body">
                                <form id="form_advanced_validation" method="post" action="<?= base_url();?>sma/edit_bg_baik">
                                    <input type="hidden" class="form-control" value="<?= $p['tahun'];?>" name="tahun" required>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <b style="float: right;">
                                                    ...
                                                    <a href="<?= base_url();?>sma/hapus_bg_tdk_baik/<?= $p['id_tb_bangunan_tdk_baik'];?>" class="btn btn-default"><i class="fa fa-trash"></i></a>
                                                </b>
                                            </td>
                                        </tr>
                                        <?php $i++;?>
            ...
            <div class="modal-body">
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="body">
                                <form id="form_advanced_validation" method="post" action="<?= base_url();?>sma/edit_bg_tdk_baik">
                                    <input type="hidden" class="form-control" value="<?= $p['tahun'];?>" name="tahun" required>
            ...
            <div class="modal-body">
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="body">
                                <form id="form_advanced_validation" method="post" action="<?= base_url();?>sma/edit_pgl_negeri">
                                    <input type="hidden" class="form-control" value="<?= $p['tahun'];?>" name="tahun" required>
            ...
            <div class="modal-body">
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="body">
                                <form id="form_advanced_validation" method="post" action="<?= base_url();?>sma/edit_pgl_swasta">
                                    <input type="hidden" class="form-control" value="<?= $p['tahun'];?>" name="tahun" required>
            ...
            <div class="modal-body">
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="body">
                                <form id="form_advanced_validation" method="post" action="<?= base_url();?>sma/edit_rg_kelas">
                                    <input type="hidden" class="form-control" value="<?= $p['tahun'];?>" name="tahun" required>
            ...
            <div class="modal-body">
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="body">
                                <form id="form_advanced_validation" method="post" action="<?= base_url();?>sma/edit_pd_bersertifikat">
                                    <input type="hidden" class="form-control" value="<?= $p['tahun'];?>" name="tahun" required>
            ...
            <div class="modal-body">
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="body">
                                <form id="form_advanced_validation" method="post" action="<?= base_url();?>sma/edit_pd_tdk_bersertifikat">
                                    <input type="hidden" class="form-control" value="<?= $p['tahun'];?>" name="tahun" required>
            ...
            <div class="modal-body">
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="body">
                                <form id="form_advanced_validation" method="post" action="<?= base_url();?>sma/edit_rasio">
                                    <input type="hidden" class="form-control" value="<?= $p['tahun'];?>" name="tahun" required>
