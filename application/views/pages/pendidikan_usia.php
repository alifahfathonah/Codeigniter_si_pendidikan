            ...
            <div class="modal-body">
                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="body">
                                <form id="form_advanced_validation" method="post" action="pendidikanusia/tambahDataPendidikan">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <p>Kecamatan</p>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <b style="float: right;">
                                                    ...
                                                    <a href="<?= base_url();?>pendidikanusia/hapus_pendidikan_usia/<?= $p['id_pendidikan_usia'];?>" class="btn btn-default"><i class="fa fa-trash"></i></a>
                                                </b>
                                            </td>
                                        </tr>
                                        <?php $i++;?>
            ...
            <div class="modal-body">
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="body">
                                <form id="form_advanced_validation" method="post" action="<?= base_url();?>pendidikanusia/edit_pendidikan0_6">
            ...
            <div class="modal-body">
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="body">
                                <form id="form_advanced_validation" method="post" action="<?= base_url();?>pendidikanusia/edit_pendidikan7_12">
                                    <input type="hidden" class="form-control" value="<?= $p['tahun'];?>" name="tahun" required>
                                    <input type="hidden" class="form-control" value="<?= $p['id_pendidikan_usia'];?>" name="id_pendidikan_usia" required>
                                    <input type="hidden" class="form-control" value="<?= $p['nama_kecamatan'];?>" name="nama_kecamatan" required>
                                    <div class="form-group form-float ">
            ...
            <div class="modal-body">
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="body">
                                <form id="form_advanced_validation" method="post" action="<?= base_url();?>pendidikanusia/edit_pendidikan13_15">
                                    <input type="hidden" class="form-control" value="<?= $p['tahun'];?>" name="tahun" required>
                                    <input type="hidden" class="form-control" value="<?= $p['id_pendidikan_usia'];?>" name="id_pendidikan_usia" required>
                                    <input type="hidden" class="form-control" value="<?= $p['nama_kecamatan'];?>" name="nama_kecamatan" required>
                                    <div class="form-group form-float ">
            ...
            <div class="modal-body">
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="body">
                                <form id="form_advanced_validation" method="post" action="<?= base_url();?>pendidikanusia/edit_pendidikan16_18">
                                    <input type="hidden" class="form-control" value="<?= $p['tahun'];?>" name="tahun" required>
                                    <input type="hidden" class="form-control" value="<?= $p['id_pendidikan_usia'];?>" name="id_pendidikan_usia" required>
                                    <input type="hidden" class="form-control" value="<?= $p['nama_kecamatan'];?>" name="nama_kecamatan" required>
                                    <div class="form-group form-float ">
